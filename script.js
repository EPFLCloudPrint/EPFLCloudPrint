...
var addFile, centerCloud, centerDialog, clearFileList, files, loadingFiles, message, removeFile, sendPrint, showError, showPrint, showUpload, toggleSelectedOnly, toggleSelection, updateProgression, uploadFile, wasTicked;
...
sendPrint = function() {
  ...
  if (!form['error']) {
    ...
    return $.ajax('php/print.php', {
      ...
      complete: function() {
        clearFileList();
        return $('#printButton').addClass('_disabled');
      }
    });
  }
};
