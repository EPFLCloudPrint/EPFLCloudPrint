...
(function() {
  var addFile, centerCloud, centerDialog, clearFileList, files, message, removeFile, removeFileServer, sendPrint, showError, showPrint, showUpload, toggleSelectedOnly, toggleSelection, uploadFile, wasTicked;
