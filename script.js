...
var addFile, centerCloud, centerDialog, files, message, removeFile, sendPrint, showError, showPrint, showUpload, toggleSelectedOnly, toggleSelection, uploadFile, wasTicked;
...
jQuery.fn.validate = function() {
  ...
  form.find('._numberField').each(function() {
    if (!(result[$(this).attr('name')] = parseInt($(this).val()))) {
      showError($(this));
...
centerCloud = function() {
  ...
  if ($('div.container').width() >= 768) {
    ...
    return $('#cloud_column').css('margin-top', h);
  } else {
    return $('#cloud_column').css('margin-top', 0);
  }
};
...
showUpload = function() {
  $('.options').slideUp(function() {
    return $('#button_wrapper').slideDown(centerDialog);
  });
  return $('.formUpload')[0].reset();
};

showPrint = function() {
  return $('#button_wrapper').slideUp(function() {
